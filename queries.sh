...
echo  "$($PSQL "SELECT year, name FROM teams RIGHT JOIN games ON teams.team_id=games.winner_id WHERE round='Final' AND winner_goals>opponent_goals ORDER BY year")"
